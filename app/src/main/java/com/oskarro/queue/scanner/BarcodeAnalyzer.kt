package com.oskarro.queue.scanner
...
import com.oskarro.queue.activities.GoogleUpdateStageByCodeActivity
import com.oskarro.queue.utils.NonActivityUtil
...
class BarcodeAnalyzer(
    ...
    override fun analyze(image: ImageProxy) {
        ...
        if (img != null) {
            ...
            // Create an InputImage object from the received image via the fromMediaImage method
